            ...
            <div class="row">
                ...
                <div class="col-sm-4"> 
                    ...
                    <form class="form-horizontal" action="#" method="POST">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="pwd1">Choisissez un password:</label>
                                <input type="password" class="form-control" name="pass1" id="pwd1" placeholder="">
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="pwd2">confirmez votre password:</label>
                        ...
                        <div class="form-inline"> 
                            ...
                            <div class="col-sm-offset-2">
                                <button type="submit" name="log" class="btn btn-default" > <a href="">Retour</a> </button>
                            </div>
                        </div>
                    </form>
